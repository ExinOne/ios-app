...
public class Localized {
    ...
    // Error
    public static let PERMISSION_DENIED_CAMERA = LocalizedString("permission_denied_camera", comment: "一心 doesn't have permission to use your camera. Please tap Setting to open system settings.")
    public static let PERMISSION_DENIED_PHOTO_LIBRARY = LocalizedString("permission_denied_photo_library", comment: "一心 doesn't have permission to use your photo library. Please tap Setting to open system settings.")
    public static let PERMISSION_DENIED_MICROPHONE = LocalizedString("permission_denied_microphone", comment: "一心 doesn't have permission to use your microphone. Please tap Setting to open system settings.")
    ...
    public static func NAVIGATION_TITLE_ENTER_EMERGENCY_CONTACT_VERIFICATION_CODE(id: String) -> String {
        return String(format: LocalizedString("navigation_title_enter_emergency_contact_verification_code", comment: "Enter the 4-digit code sent to 一心 ID %@"), id)
    }
    ...
    public static let CONTACT_ADD_SUMMARY = LocalizedString("contact_add_summary", comment: "Add people by 一心 ID or phone number")
    public static let CONTACT_QR_CODE_TITLE = LocalizedString("contact_qr_code_title", comment: "一心 QR Code")
    public static let CONTACT_QR_CODE_SUMMARY = LocalizedString("contact_qr_code_summary", comment: "Scan a friend's 一心 QR Code")
    ...
    public static let CONTACT_INVITE = LocalizedString("contact_invite", comment: "Hey, I'm using 一心 Messenger to chat. Download it here: https://一心.one/messenger")
    ...
    public static let CONTACT_PHONE_CONTACT_SUMMARY = LocalizedString("contact_phone_contact_summary", comment: "一心 needs access to your contacts to help you connect with other people on 一心.")
    public static func CONTACT_MY_IDENTITY_NUMBER(id: String) -> String {
        return String(format: LocalizedString("contact_my_identity_number", comment: "My 一心 ID: %@"), id)
    }
    public static func CONTACT_IDENTITY_NUMBER(identityNumber: String) -> String {
        return String(format: LocalizedString("contact_identity_number", comment: "一心 ID: %@"), identityNumber)
    }
    ...
    public static let PLACEHOLDER_MIXIN_ID_OR_PHONE = LocalizedString("placeholder_一心_id_or_phone", comment: "一心 ID, Phone number")
    ...
    public static let CHAT_CELL_TITLE_UNKNOWN_CATEGORY = LocalizedString("chat_cell_title_unknown_category", comment: "This type of message is not supported, please upgrade 一心 to the latest version.")
    ...
    public static let GROUP_JOIN_FAIL_SUMMARY = LocalizedString("group_join_fail_summary", comment: "This invite link doesn't match any 一心 groups.")
    public static let CODE_RECOGNITION_FAIL_TITLE = LocalizedString("code_recognition_fail_title", comment: "Unrecognized codes")
    public static let CODE_RECOGNITION_FAIL_SUMMARY = LocalizedString("code_recognition_fail_summary", comment: "This codes doesn't match any 一心 groups or users.")
    ...
    public static let MYQRCODE_PROMPT = LocalizedString("myqrcode_prompt", comment: "Scan the QR Code to add me on 一心")
    public static let NOT_一心_QR_CODE = LocalizedString("not_一心_qr_code", comment: "Not 一心 QR Code")
    ...
    public static let TRANSFER_QRCODE_PROMPT = LocalizedString("transfer_qrcode_prompt", comment: "Scan the QR Code to transfer me on 一心")
    ...
    public static func PROFILE_MIXIN_ID(id: String) -> String {
        return String(format: LocalizedString("profile_一心_id", comment: "一心 ID: %@"), id)
    }
